...
export default function Posts() {
    ...
    return (
        <div class="posts">
            ...
            {arraypost.map(post => <Post src1atributo={post.src1} alt1atributo={post.alt1} usuarioatributo={post.usuario} src2atributo={post.src2} alt2atributo={post.alt2} src3atributo={post.src3} alt3atributo={post.alt3} usercurtidaatributo={post.usercurtida} numerocurtidasatributo={post.numerocurtidas} />)}
